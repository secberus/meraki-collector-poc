...
func init() {
	...
	pf.StringP("push-credentials", "p", "", "Push datasource credentials bundle (overrides `push` in configuration file) (default: $HOME/.s6s/config)")
	viper.BindPFlag(config.BundleFileKey, pf.Lookup("push-credentials"))
